...
<div class="demo-block">
  <w-button icon="l-icon-newspaper" type="primary"></w-button>
  <w-button icon="l-icon-quill" type="primary"></w-button>
  <w-button icon="l-icon-pencil" type="primary"></w-button>
  <w-button icon="l-icon-search" type="primary">搜索</w-button>
  <w-button icon="l-icon-download2" type="primary">下载</w-button>
</div>
